...
const pageGroups: PageGroup[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { path: '/character-story-profiles', name: 'Character Story Profiles', icon: BookOpenIcon },
      { path: '/character-relationships', name: 'Character Relationships', icon: UserGroupIcon },
      { path: '/character-story-beats', name: 'Character Story Beats', icon: ClockIcon },
