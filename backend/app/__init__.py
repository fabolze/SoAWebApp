...
from backend.app.routes.r_character_narrative import (
    relationships_bp as character_relationships_bp,
...
from backend.app.routes.r_ui_character_studio import bp as ui_character_studio_bp
